...
- [guysoft/CustomPiOS](https://github.com/guysoft/CustomPiOS) ([2.0.0](https://github.com/guysoft/CustomPiOS/releases/tag/2.0.0), 10 days ago) - A Raspberry Pi and other ARM devices distribution builder
- [guysoft/opencode-termux](https://github.com/guysoft/opencode-termux) ([v0.2.1](https://github.com/guysoft/opencode-termux/releases/tag/v0.2.1), 29 days ago) - OpenCode AI coding assistant for Android/Termux - cross-compiled Bun + WebKit/JSC for aarch64
