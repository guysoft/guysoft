...
- [twisted/twisted](https://github.com/twisted/twisted) - Event-driven networking engine written in Python. (14 hours ago)
...
- [guysoft/FullPageOS](https://github.com/guysoft/FullPageOS) - A raspberrypi distro to display a full page browser on boot (8 days ago)
- [guysoft/CustomPiOS](https://github.com/guysoft/CustomPiOS) - A Raspberry Pi and other ARM devices distribution builder (7 days ago)
...
- [guysoft/CustomPiOS](https://github.com/guysoft/CustomPiOS) ([2.0.0](https://github.com/guysoft/CustomPiOS/releases/tag/2.0.0), 7 days ago) - A Raspberry Pi and other ARM devices distribution builder
- [guysoft/opencode-termux](https://github.com/guysoft/opencode-termux) ([v0.2.1](https://github.com/guysoft/opencode-termux/releases/tag/v0.2.1), 26 days ago) - OpenCode AI coding assistant for Android/Termux - cross-compiled Bun + WebKit/JSC for aarch64
